...
public class Benchmarking {
    ...
    public static void main(String[] args) {
        NN nn = new NN("numberclassifier", 0, 0, LossFunction.CROSSENTROPY(1), Optimizer.ADADELTA,
                new Conv(10, 1, 3, 3, 1, 0, 0, Activation.LEAKYRELU),//1x28x28 conv(s=1) 10x1x3x3 = 10x26x26
                new Conv(7, 10, 4, 4, 2, 0, 0, Activation.LEAKYRELU),//10x26x26 conv(s=2) 7x10x4x4 = 7x12x12
                new Conv(4, 7, 5, 5, 1, 0, 0, Activation.LEAKYRELU),//7x12x12 conv(s=1) 4x7x5x5 = 4x8x8
                new Conv(1, 4, 6, 6, 1, 0, 0, Activation.LEAKYRELU),//4x8x8 conv(s=1) 1x4x6x6 = 1x3x3
